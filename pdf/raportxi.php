...
$pdf->Cell(3);
$pdf->Cell(10,$f,$no++,'LRB',0, 'C');
$pdf->Cell(50,$f,'Bahasa Jawa', 'LRB',0, 'L');
...
$i=1;
$j=1;
$cpm='Menunjukkan penguasaan yang baik dalam '.$cp['b_arab_cpm'];
$cpp='Perlu ditingkatkan dalam '.$cp['b_arab_cpp'];
$char_cpm=strlen($cpm);
$char_cpp=strlen($cpp);
if ($char_cpm>75)
        {$i=2;}
...
$pdf->Cell(3);
$pdf->Cell(10,$f,$no++,'LRB',0, 'C');
$pdf->Cell(50,$f,'Bahasa Arab', 'LRB',0, 'L');
$pdf->Cell(20,$f,$leger['b_arab'],'LRB',0, 'C');
$x = $pdf->GetX();
$pdf->MultiCell($w,$h,$cpm,'LRB','J',FALSE);
$pdf->SetX($x);
$pdf->MultiCell($w,$h,$cpp,'LRB','J',FALSE);
...
$pdf->MultiCell(50,$f,"", "B",'L');
$pdf->SetXY($x, $y+$i+$j+$h);
$pdf->MultiCell(50,$f/8,'Konsentrasi Keahlian Rekayasa Perangkat Lunak','', 'L');
$pdf->SetXY($x+50, $y);
}
if ($leger['jurusan']=="TE")
{
$pdf->MultiCell(50,$f,"", "B",'L');
$pdf->SetXY($x, $y+$i+$j+$h); 
$pdf->MultiCell(50,$f/8,'Konsentrasi Keahlian Teknik Audio Video', '', 'L');
$pdf->SetXY($x+50, $y);
}
...
$pdf->MultiCell(50,$f,"", "B",'L');
$pdf->SetXY($x, $y+$i+$j+$h); 
$pdf->Cell(50,$f/8,'Konsentrasi Keahlian Teknik Mekanik Industri', '', 'L');
$pdf->SetXY($x+50, $y);
}
...
$pdf->MultiCell(50,$f,"", "B",'L');
$pdf->SetXY($x, $y+$i+$j+$h);
$pdf->Cell(50,$f/8,'Konsentrasi Keahlian Teknik Kendaraan Ringan', '', 'L');
$pdf->SetXY($x+50, $y);
}
...
$pdf->MultiCell(50,$f,"", "B",'L');
$pdf->SetXY($x, $y+$i+$j+$h);
$pdf->Cell(50,$f/8,'Konsentrasi Keahlian Teknik Sepeda Motor', '', 'L');
$pdf->SetXY($x+50, $y);
}
...
$i=1;
$j=1;
$cpm='Menunjukkan penguasaan yang baik dalam '.$cp['mapel_pilihan_cpm'];
$cpp='Perlu ditingkatkan dalam '.$cp['mapel_pilihan_cpp'];
$char_cpm=strlen($cpm);
$char_cpp=strlen($cpp);
if ($char_cpm>75)
        {$i=2;}
...
$pdf->Cell(3);
$pdf->Cell(10,$f,$no++,'LRB',0, 'C');
$pdf->Cell(50,$f,'Mapel Pilihan', 'LRB',0, 'L');
$pdf->Cell(20,$f,$leger['mapel_pilihan'],'LRB',0, 'C');
$x = $pdf->GetX();
$pdf->MultiCell($w,$h,$cpm,'LRB','J',FALSE);
$pdf->SetX($x);
$pdf->MultiCell($w,$h,$cpp,'LRB','J',FALSE);
...
$width_cell=array(185);
$pdf->Cell(3);
        $pdf->Cell($width_cell[0],$h,'Berdasarkan hasil yang dicapai pada Semester 3 dan 4, peserta didik ditetapkan : Naik di Kelas XII',1,1,'L');
    $pdf->SetFont('Arial','',8);
...
$width_cell=array(185);
$pdf->Cell(3);
        $pdf->Cell($width_cell[0],$h,'Berdasarkan hasil yang dicapai pada Semester 3 dan 4, peserta didik ditetapkan : Tinggal Kelas di Kelas XI',1,1,'L');
    $pdf->SetFont('Arial','',8);
