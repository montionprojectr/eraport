...
for ($i=0; $i<$jum; $i++)
{
    mysqli_query($koneksi,"update tb_leger set nis='$nis[$i]', nama='$nama[$i]' , eks1='$eks1[$i]', eks2='$eks2[$i]', eks3='$eks3[$i]', eks4='$eks4[$i]', eks5='$eks5[$i]', eks6='$eks6[$i]', eks7='$eks7[$i]' where id='$id[$i]' ") 
    or die(mysqli_error($koneksi));
}
    echo "<script>
   
    document.location='pembina?page=ekskul&id_walikelas=".$rows['id_walikelas']."'</script>";
 }
?>
